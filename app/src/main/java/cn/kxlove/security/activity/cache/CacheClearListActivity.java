package cn.kxlove.security.activity.cache;
...
import cn.kxlove.security.adapter.CacheCleanAdapter;
import cn.kxlove.security.model.CacheInfo;

@ContentView(R.layout.activity_cache_clear_list)
public class CacheClearListActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        setStatusBarColor(getResources().getColor(R.color.rose_red));
    ...
    @Event(value = {R.id.imgv_leftbtn,R.id.btn_cleanall})
