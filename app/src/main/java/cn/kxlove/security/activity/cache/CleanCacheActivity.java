...
//    @ViewInject(R.id.imgv_trashbin_cacheclean)
    private AnimationDrawable animation;

    @ViewInject(R.id.tv_cleancache_memory)
    private TextView mMemoryTV;

    @ViewInject(R.id.tv_cleancache_memoryunit)
    private TextView mMemoryUnitTV;

    @ViewInject(R.id.fl_cleancache)
    private FrameLayout mCleanCacheFL;

    @ViewInject(R.id.fl_finishclean)
    private FrameLayout mFinishCleanFL;

    @ViewInject(R.id.tv_cleanmemorysize)
    ...
    @Event(value = {R.id.imgv_leftbtn,R.id.btn_finish_cleancache})
